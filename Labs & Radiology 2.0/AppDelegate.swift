...
//	}
    ...
    func clearForm () {
        ...
        bmpView.addItemsWithObjectValues(["", "Z79.899 (MedUse)", "Z79.891 (MedOpi)", "Z00.00", "I10 (HTN)", "E11.9 (DMII)", "E11.65", "N18.9"])
        bmpView.selectItemAtIndex(0)
        cmpView.removeAllItems()
        cmpView.addItemsWithObjectValues(["", "Z79.899 (MedUse)", "Z79.891 (MedOpi)", "Z00.00", "I10 (HTN)", "E11.9 (DMII)", "N18.9", "R10.9"])
        ...
        tshView.addItemsWithObjectValues(["", "Z79.899 (MedUse)", "Z79.891 (MedOpi)", "Z00.00", "E03.9 (LothyU)", "R53.83 (FatigO)", "R53.1 (Wk)", "R53.81 (Malais)", "G93.3 (FatigPV)"])
        tshView.selectItemAtIndex(0)
        ft4view.removeAllItems()
        ft4view.addItemsWithObjectValues(["", "Z79.899 (MedUse)", "Z79.891 (MedOpi)", "Z00.00", "E03.9 (LothyU)", "R53.83 (FatigO)", "R53.1 (Wk)", "R53.81 (Malais)", "G93.3 (FatigPV)"])
        ft4view.selectItemAtIndex(0)
        ft3View.removeAllItems()
        ft3View.addItemsWithObjectValues(["", "Z79.899 (MedUse)", "Z79.891 (MedOpi)", "Z00.00", "E03.9 (LothyU)", "R53.83 (FatigO)", "R53.1 (Wk)", "R53.81 (Malais)", "G93.3 (FatigPV)"])
        ...
        lpdView.addItemsWithObjectValues(["", "Z79.899 (MedUse)", "Z79.891 (MedOpi)", "Z00.00", "E78.4 (LpdO)", "E78.2 (LpdMx)", "E78.0 (LpdChl)", "E11.9 (DMII)", "E11.65"])
        lpdView.selectItemAtIndex(0)
        psaView.removeAllItems()
        psaView.addItemsWithObjectValues(["", "Z79.899 (MedUse)", "Z79.891 (MedOpi)", "Z00.00", "Z12.5 (PSAScrn)", "N40.0", "600.01", "C61"])
        psaView.selectItemAtIndex(0)
        udipView.removeAllItems()
        udipView.addItemsWithObjectValues(["", "Z79.899 (MedUse)", "Z79.891 (MedOpi)", "Z00.00", "R35.0 (U Freq)", "R39.15 (U Urg)", "R30.0 (Dysur)", "R30.9 (PainUr)", "788.31", "R35.1 (Nocturia)", "N39.0 (UTI)", "R31.0", "R31.2 (McrHemU)"])
        udipView.selectItemAtIndex(0)
        ucxView.removeAllItems()
        ucxView.addItemsWithObjectValues(["", "Z79.899 (MedUse)", "Z79.891 (MedOpi)", "Z00.00", "N39.0 (UTI)"])
        ...
        lpdnmrView.addItemsWithObjectValues(["", "Z79.899 (MedUse)", "Z79.891 (MedOpi)", "Z00.00", "E78.4 (LpdO)", "E78.2 (LpdMx)", "E78.0 (LpdChl)", "E11.9 (DMII)", "E11.65"])
        lpdnmrView.selectItemAtIndex(0)
        hba1cView.removeAllItems()
        hba1cView.addItemsWithObjectValues(["", "Z79.899 (MedUse)", "Z79.891 (MedOpi)", "Z00.00", "E11.9 (DMII)", "E11.65", "250.01", "250.03", "R73.09 (AbGlu)"])
        hba1cView.selectItemAtIndex(0)
        umalbView.removeAllItems()
        umalbView.addItemsWithObjectValues(["", "Z79.899 (MedUse)", "Z79.891 (MedOpi)", "Z00.00", "E11.9 (DMII)", "E11.65", "250.01", "250.03", "I10 (HTN)", "N18.9"])
        ...
        uprcrView.addItemsWithObjectValues(["", "Z79.899 (MedUse)", "Z79.891 (MedOpi)", "Z00.00", "N18.9", "R80.9 (PrtnUr)", "E11.9 (DMII)", "I10 (HTN)"])
        uprcrView.selectItemAtIndex(0)
        ptinrView.removeAllItems()
        ptinrView.addItemsWithObjectValues(["", "Z79.899 (MedUse)", "Z79.891 (MedOpi)", "Z00.00", "Z79.01 (AnticoagUse)", "R23.3", "Z01.812 (PreOp)", "Z01.818 (PreOpOther)"])
